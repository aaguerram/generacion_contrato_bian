...
- Token cost: 12,817 input · 15,926 output
...
- Similarity Band Classification
...
- Use Cases and Ports
- Abstract Port Contracts
- LangGraph Use Case Orchestration
- Configuration & Composition Root
- Pure Domain Core
- BIAN Domain Validation
- AI Contract Generation
- CLI Entry Points
- Fake LLM Strategy
- File Node Cache
- BIAN Mapping Analyst
- BOM Catalog Adapter
- Result Publishing & Validation
- Hybrid Graph RAG Plan
- Story-Domain Mapping Service
- Story Domain Operation Anchoring
- LLM Service Domain Adjudication
- Config Paths and Ordering
- Service Domain Validation State
- Project Pipeline Documentation
- Resilient Embeddings Retry
- Reranker Strategies
- Domain Classification Rules
- Omitted Service Domain Detection
- Outbound Adapters
- Mapping Result Publishing
- Retrieval Quality Evaluation
- BIAN Catalog Cache Tests
- User Story Mapping Use Case
- SVG to PUML Control
- Service Domain Classification
- BIAN Object Catalog Loading
- Chat Adapter Protocol
- YAML Configuration Loading
- Prompt Agnosticism Tests
- LLM Candidate Evaluation
- SVG to PUML Converter
- Graph Path Testing
- Domain Assignment & Evidence
- BIAN Catalog Fetching
- Reciprocal Rank Fusion
- BIAN Official Cache
- Project Configuration Guide
- Catalog Evidence Retrieval
- Hybrid Retrieval Mapping Tests
- MEMANTO Memory Structure
- BOM Schema Formatting
- LangGraph Graphs Documentation
- BIAN Operation Mapping
- Implementation Plan and Phases
- Hexagonal Architecture Rules
- Story-to-SD Graph Architecture
- E2E Test Utilities
- HU Correspondence Debug Query
- Phase 3 Hybrid RAG
- BIAN Canonical Model Ingestion
- External Vector Store Setup
- Phase 4 Reranker Graph RAG
- Vector Store Architecture Decision
- RAG Retrieval Adapters
- Embeddings Failover Wrapper
- MEMANTO Memory Skill Guide
- MEMANTO Setup and Config
- Chat Model Failover Tests
- BIAN Operation Mapping
- Operation ID Resolution
- LLM Provider Strategies
- LangGraph SQLite Checkpointer
- Domain Role Promotion & Degradation
- BIAN Entity Generation
- Operation Proposal Merging
- Chat Model Abstraction
- BIAN SVG Download
- SVG to PUML Conversion
- E2E Testing Guidelines
- BIAN View Catalog Builder
- Fake Embeddings Strategy
- Agent Memory Operations
- BIAN View Catalog Tool
- SVG Control Record Download
- BIAN Catalog Normalization
- BIAN UML PlantUML Extraction
- Personal Data E2E Test
- Chat Failover Chain
- Mock Chat Model
- BM25 Index Implementation
- Adversarial Review Application
- BIAN Catalog Authority Tests
- Test Generation & Index Migration
- BIAN Graph Node Identity
- Action-Based Promotion Rules
- BIAN Matrix View Generation
- MEMANTO Session Start Hook
- Service Landscape Enrichment
- Graph-Based Conflict Confirmation
- Failing Analyst Test Double
- No-Contract Story Testing
- Lexical BM25 Retrieval
- Contract Generation Design Decisions
- Project Learnings and Root Causes
- BIAN Catalog Prompt Formatting
- BIAN Graph Expansion Port
- BIAN Graph Ingestion
- BIAN Graph Data Model
- Project Facts and Environment
- BIAN Entity Generation
- BIAN Matrix View Generation
- MEMANTO Notification Hook
- SVG to PlantUML Conversion
- SD Prose Text Tests
- Service Landscape Loading
- Shared Object Detection
- BIAN Object Catalog Docs
- Retrieval Evaluation Benchmark
- BIAN JSON Graph Loading
- Service Landscape Enrichment
- Pipeline Canary Comparison
- Retrieval Index Rebuild
- BIAN Story-to-SD Analyst
- Cohere Embeddings Strategy
- Structured Output Model
- OpenAI Provider Strategy
- SD Semantic Index Text
- SMART Token Regression Tests
- Golden Corpus Expansion Guide
- BIAN Ingestion Pipeline
- Provider Priority Routing Tests
- Ingested Graph Integrity Tests
- E2E Personal Data Tests
- Iteration Status and Backlog
- Ollama Graphify Configuration
- Contract Generation Observability
- LLM Call Timing Wrapper
- BIAN Contract Generation Goals
- HU to BIAN Mapping Prompts
- Index Migration
- Path Utilities
...
8. `ServiceDomainsDeHistoria` - 49 edges
9. `EvidenciaBian` - 49 edges
10. `HistoriaUsuario` - 46 edges

## Surprising Connections (you probably didn't know these)
- `TestRecuperadorBM25` --uses--> `RecuperadorBM25`  [INFERRED]
  tests/unit_test/test_bm25_y_fusion.py → src/adaptadores/salida/recuperador_bm25.py
- `TestDeterminarDegradaciones` --uses--> `HallazgoAdversarial`  [INFERRED]
  tests/unit_test/test_clasificacion_historias.py → src/dominio/historias.py
- `TestDeterminarPromociones` --uses--> `HallazgoAdversarial`  [INFERRED]
  tests/unit_test/test_clasificacion_historias.py → src/dominio/historias.py
- `_AnalistaActualizacionMalClasificada` --uses--> `HallazgoAdversarial`  [INFERRED]
  tests/unit_test/test_grafo_mapeo.py → src/dominio/historias.py
- `_AnalistaNotificacion` --uses--> `HallazgoAdversarial`  [INFERRED]
  tests/unit_test/test_grafo_mapeo.py → src/dominio/historias.py
...
### Community 0 - "Similarity Band Classification"
Cohesion: 0.19
...
### Community 1 - "LLM Provider Strategies"
Cohesion: 0.11
...
### Community 2 - "Evidence Citation Validation"
Cohesion: 0.08
...
### Community 5 - "Multi-Provider Failover"
Cohesion: 0.15
...
### Community 6 - "User Story Reading"
Cohesion: 0.07
...
### Community 7 - "BIAN Service Domain Catalog"
Cohesion: 0.11
...
### Community 23 - "BIAN Mapping Analyst"
Cohesion: 0.27
...
### Community 24 - "BOM Catalog Adapter"
Cohesion: 0.10
...
### Community 25 - "Result Publishing & Validation"
Cohesion: 0.15
...
### Community 26 - "Hybrid Graph RAG Plan"
Cohesion: 0.06
...
### Community 27 - "Story-Domain Mapping Service"
Cohesion: 0.06
...
### Community 28 - "Story Domain Operation Anchoring"
Cohesion: 0.20
...
### Community 29 - "LLM Service Domain Adjudication"
Cohesion: 0.22
...
### Community 33 - "Resilient Embeddings Retry"
Cohesion: 0.29
...
### Community 34 - "Reranker Strategies"
Cohesion: 0.10
...
### Community 35 - "Domain Classification Rules"
Cohesion: 0.18
...
### Community 36 - "Omitted Service Domain Detection"
Cohesion: 0.32
...
### Community 38 - "Mapping Result Publishing"
Cohesion: 0.31
...
### Community 39 - "Retrieval Quality Evaluation"
Cohesion: 0.17
...
### Community 41 - "User Story Mapping Use Case"
Cohesion: 0.18
...
### Community 42 - "SVG to PUML Control"
Cohesion: 0.10
...
### Community 43 - "Service Domain Classification"
Cohesion: 0.11
...
### Community 44 - "BIAN Object Catalog Loading"
Cohesion: 0.14
...
### Community 48 - "LLM Candidate Evaluation"
Cohesion: 0.07
...
### Community 49 - "SVG to PUML Converter"
Cohesion: 0.12
...
### Community 52 - "BIAN Catalog Fetching"
Cohesion: 0.07
...
### Community 53 - "Reciprocal Rank Fusion"
Cohesion: 0.18
...
### Community 56 - "Project Configuration Guide"
Cohesion: 0.25
...
### Community 57 - "Catalog Evidence Retrieval"
Cohesion: 0.14
...
### Community 58 - "Hybrid Retrieval Mapping Tests"
Cohesion: 0.33
...
### Community 59 - "MEMANTO Memory Structure"
Cohesion: 0.17
...
### Community 60 - "BOM Schema Formatting"
Cohesion: 0.20
...
### Community 61 - "LangGraph Graphs Documentation"
Cohesion: 0.33
...
### Community 62 - "BIAN Operation Mapping"
Cohesion: 0.07
...
### Community 63 - "Implementation Plan and Phases"
Cohesion: 0.18
...
### Community 64 - "Hexagonal Architecture Rules"
Cohesion: 0.25
...
### Community 65 - "Story-to-SD Graph Architecture"
Cohesion: 0.29
...
### Community 66 - "E2E Test Utilities"
Cohesion: 0.14
...
### Community 67 - "HU Correspondence Debug Query"
Cohesion: 0.40
...
### Community 68 - "Phase 3 Hybrid RAG"
Cohesion: 0.40
...
### Community 71 - "Phase 4 Reranker Graph RAG"
Cohesion: 0.40
Nodes (5): 4. Fase 4 — Reranker + Graph RAG, Justificación, Pasos, Problema, Ventaja

### Community 72 - "Vector Store Architecture Decision"
Cohesion: 0.13
...
### Community 74 - "RAG Retrieval Adapters"
Cohesion: 0.12
...
### Community 75 - "Embeddings Failover Wrapper"
Cohesion: 0.12
...
### Community 76 - "MEMANTO Memory Skill Guide"
Cohesion: 0.13
...
### Community 77 - "MEMANTO Setup and Config"
Cohesion: 0.28
...
### Community 79 - "BIAN Operation Mapping"
Cohesion: 0.19
...
### Community 80 - "Operation ID Resolution"
Cohesion: 0.16
...
### Community 81 - "LLM Provider Strategies"
Cohesion: 0.14
...
### Community 82 - "LangGraph SQLite Checkpointer"
Cohesion: 0.12
...
### Community 83 - "Domain Role Promotion & Degradation"
Cohesion: 0.21
...
### Community 84 - "BIAN Entity Generation"
Cohesion: 0.19
...
### Community 85 - "Operation Proposal Merging"
Cohesion: 0.40
...
### Community 86 - "Chat Model Abstraction"
Cohesion: 0.29
Nodes (4): ChatResult, _FakeChat, BaseChatModel, Runnable

### Community 87 - "BIAN SVG Download"
Cohesion: 0.36
...
### Community 88 - "SVG to PUML Conversion"
Cohesion: 0.25
...
### Community 89 - "E2E Testing Guidelines"
Cohesion: 0.29
...
### Community 90 - "BIAN View Catalog Builder"
Cohesion: 0.38
...
### Community 91 - "Fake Embeddings Strategy"
Cohesion: 0.36
...
### Community 92 - "Agent Memory Operations"
Cohesion: 0.33
...
### Community 95 - "BIAN Catalog Normalization"
Cohesion: 0.20
...
### Community 97 - "Personal Data E2E Test"
Cohesion: 0.33
...
### Community 98 - "Chat Failover Chain"
Cohesion: 0.21
...
### Community 104 - "Adversarial Review Application"
Cohesion: 0.19
...
### Community 105 - "BIAN Catalog Authority Tests"
Cohesion: 0.12
...
### Community 106 - "Test Generation & Index Migration"
Cohesion: 0.15
...
### Community 107 - "BIAN Graph Node Identity"
Cohesion: 0.21
...
### Community 108 - "Action-Based Promotion Rules"
Cohesion: 0.25
...
### Community 109 - "BIAN Matrix View Generation"
Cohesion: 0.22
...
### Community 110 - "MEMANTO Session Start Hook"
Cohesion: 0.21
...
### Community 111 - "Service Landscape Enrichment"
Cohesion: 0.20
...
### Community 112 - "Graph-Based Conflict Confirmation"
Cohesion: 0.21
...
### Community 113 - "Failing Analyst Test Double"
Cohesion: 0.21
...
### Community 114 - "No-Contract Story Testing"
Cohesion: 0.17
...
### Community 115 - "Lexical BM25 Retrieval"
Cohesion: 0.14
...
### Community 116 - "Contract Generation Design Decisions"
Cohesion: 0.13
...
### Community 117 - "Project Learnings and Root Causes"
Cohesion: 0.13
...
### Community 118 - "BIAN Catalog Prompt Formatting"
Cohesion: 0.19
...
### Community 119 - "BIAN Graph Expansion Port"
Cohesion: 0.22
...
### Community 120 - "BIAN Graph Ingestion"
Cohesion: 0.26
...
### Community 121 - "BIAN Graph Data Model"
Cohesion: 0.23
...
### Community 122 - "Project Facts and Environment"
Cohesion: 0.17
...
### Community 123 - "BIAN Entity Generation"
Cohesion: 0.17
...
### Community 124 - "BIAN Matrix View Generation"
Cohesion: 0.17
...
### Community 125 - "MEMANTO Notification Hook"
Cohesion: 0.31
...
### Community 126 - "SVG to PlantUML Conversion"
Cohesion: 0.18
...
### Community 127 - "SD Prose Text Tests"
Cohesion: 0.18
...
### Community 128 - "Service Landscape Loading"
Cohesion: 0.24
...
### Community 129 - "Shared Object Detection"
Cohesion: 0.24
...
### Community 130 - "BIAN Object Catalog Docs"
Cohesion: 0.22
...
### Community 131 - "Retrieval Evaluation Benchmark"
Cohesion: 0.22
...
### Community 132 - "BIAN JSON Graph Loading"
Cohesion: 0.33
Nodes (3): GrafoBianJson, Path, TestGrafoBianJsonSinArchivo

### Community 133 - "Service Landscape Enrichment"
Cohesion: 0.25
...
### Community 134 - "Pipeline Canary Comparison"
Cohesion: 0.39
...
### Community 135 - "Retrieval Index Rebuild"
Cohesion: 0.43
...
### Community 136 - "BIAN Story-to-SD Analyst"
Cohesion: 0.39
...
### Community 137 - "Cohere Embeddings Strategy"
Cohesion: 0.29
...
### Community 146 - "E2E Personal Data Tests"
Cohesion: 0.33
...
### Community 147 - "Iteration Status and Backlog"
Cohesion: 0.40
...
### Community 148 - "Ollama Graphify Configuration"
Cohesion: 0.40
Nodes (4): OLLAMA_API_KEY, OLLAMA_BASE_URL, OLLAMA_MODEL, graphify-ollama.sh script

### Community 149 - "Contract Generation Observability"
Cohesion: 0.50
...
### Community 151 - "BIAN Contract Generation Goals"
Cohesion: 0.67
Nodes (3): Goals, Pendiente en generacion_contrato_bian para retomar..., Retrieval hibrido RRF (src/dominio/fusion_rrf.py, ...

## Knowledge Gaps
- **249 isolated node(s):** `A escala de 341 Service Domains el recall de recup...`, `Arquitectura de mapear-historias: outer graph con ...`, `Asimetria estructural del ownership en generacion_...`, `BOM extendido: CatalogoBianCache._normalizar usa c...`, `Checkpointer persistente de generacion_contrato_bi...` (+244 more)
...
- **Why does `CatalogoJson` connect `BIAN Catalog Cache` to `Service Landscape Loading`, `Retrieval Index Rebuild`, `BIAN Service Domain Catalog`, `SMART Token Regression Tests`, `File Node Cache`, `Retrieval Quality Evaluation`, `User Story Mapping Use Case`, `Graph Path Testing`, `Hybrid Retrieval Mapping Tests`, `BIAN Operation Mapping`, `BIAN Catalog Normalization`, `BM25 Index Implementation`, `BIAN Catalog Authority Tests`, `Test Generation & Index Migration`, `No-Contract Story Testing`, `Lexical BM25 Retrieval`, `BIAN Catalog Prompt Formatting`, `BIAN Graph Ingestion`, `SD Prose Text Tests`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `MapearHistoriasServiceDomainsService` connect `Story-Domain Mapping Service` to `BIAN Catalog Cache`, `User Story Reading`, `BIAN Service Domain Catalog`, `File Node Cache`, `BOM Catalog Adapter`, `Story Domain Operation Anchoring`, `Reranker Strategies`, `Domain Classification Rules`, `Mapping Result Publishing`, `User Story Mapping Use Case`, `Service Domain Classification`, `LLM Candidate Evaluation`, `Domain Assignment & Evidence`, `BIAN Catalog Fetching`, `Catalog Evidence Retrieval`, `Hybrid Retrieval Mapping Tests`, `BIAN Operation Mapping`, `RAG Retrieval Adapters`, `BIAN Operation Mapping`, `Adversarial Review Application`, `No-Contract Story Testing`, `BIAN Graph Expansion Port`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `normalizar()` connect `Retrieval Quality Evaluation` to `Service Landscape Loading`, `Evidence Citation Validation`, `BIAN Catalog Cache`, `BIAN Service Domain Catalog`, `BIAN Story-to-SD Analyst`, `Retrieval Index Rebuild`, `BOM Catalog Adapter`, `Story-Domain Mapping Service`, `Story Domain Operation Anchoring`, `Domain Classification Rules`, `Omitted Service Domain Detection`, `Service Domain Classification`, `Domain Assignment & Evidence`, `BIAN Catalog Fetching`, `Catalog Evidence Retrieval`, `BOM Schema Formatting`, `BIAN Operation Mapping`, `E2E Test Utilities`, `BIAN Operation Mapping`, `Operation ID Resolution`, `Domain Role Promotion & Degradation`, `BIAN Catalog Normalization`, `Adversarial Review Application`, `Test Generation & Index Migration`, `BIAN Graph Node Identity`, `Action-Based Promotion Rules`, `Graph-Based Conflict Confirmation`, `BIAN Graph Expansion Port`?**
